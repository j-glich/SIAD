...
<div class="box-header with-border">
    ...
    <button class="btn btn-xs btn btn-success" id="btnRegistrarPro">Nuevo producto</button>
  </div>
  <!-- /.box-header -->
  <div class="box-body" >
        ...
        ?>
          <tr>
            ...
            <button class="btn btn-xs btn btn-info" 
              onclick="acc_producto('C','<?php echo $fila['clave']?>')">
              ...
              onclick="acc_producto('U','<?php echo $fila['clave']?>')">
...
$(document).ready(function(){
    $("#btnRegistrarPro").click(function(e){
    e.preventDefault();
    form('../view/pda/frm_nuevoProducto.php');
