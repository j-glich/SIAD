...
<div class="box-header with-border">
    ...
    <button class="btn btn-xs btn btn-success" id="btn_categoria"> Nueva categoria</button>
    <br>
  </div>
  <!-- /.box-header -->
  <div class="box-body" >
        ...
        ?>
          <tr>
            ...
            <td style="text-align: center;">
              ...
              onclick="acc_categoria('C','<?php echo $fila['clave']?>')">
              ...
              onclick="acc_categoria('U','<?php echo $fila['clave']?>')">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    e.preventDefault();
    form('../view/pda/frm_nuevaCategoria.php');
